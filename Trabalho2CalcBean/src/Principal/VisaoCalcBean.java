...
public class VisaoCalcBean extends javax.swing.JPanel implements java.beans.Customizer {
   ...
   private void initComponents() {
      ...
      botaoPainel.setIcon(new javax.swing.ImageIcon("C:\\workspace\\Trabalho2CalcBean\\Trabalho2CalcBean\\src\\icones\\calcC32.png")); // NOI18N
   ...
   private void botaoIgualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoIgualActionPerformed
      ...
      if (getValor1() == null)
         ...
         this.campoResultado.setText("" + calcular(v, operador, v2)); // define o visor pelos parametros da função calcular
         setPontoInserido(false);
         setJaCalculou(true);
      }
